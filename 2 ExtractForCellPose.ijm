...
square_size = 200;
// Create the cellpose if doesn't exist. This will contain the 2-channel stack of the whole image generated by this script. Crops will have a randomly cropped area for training. 
