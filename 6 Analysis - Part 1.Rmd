...
date: "2024-05-16"
authors: "oscardong4@gmail.com, heeva.baharlou@gmail.com"
---
...
# Save UMAP, Heatmap, and Z-score graphs to 'Graphs' using clustering results
dir.create("../Graphs", showWarnings = FALSE)
spe_subset = clustGraphs(clustOut, ccp, clustNumber, "All", TRUE, "../Graphs")

# Generate UMAP of individual marker expression values and save to 'Graphs'
png(file.path(getwd(), "../Graphs", "markerPlots.png"), width = 3000, height = 3000, res = 300) 
