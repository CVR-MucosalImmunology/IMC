...
norm_pack = c("tidyverse", "BiocManager", "viridis", "RColorBrewer", "cowplot", "gridExtra", "tiff")
for (p in norm_pack) {
...
source("https://raw.githubusercontent.com/CVR-MucosalImmunology/IMC/main/functions.R")
```
